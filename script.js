...
for (let i = 0; i < cardsnumber/2; i++) {
    arraycards.push(`<li class="card"> 
    <img onclick="changeimg(this)" id="${foldedImgs[i]}" src="imgs/front.png" 
    alt="papagaio da frente da carta"> </li>`);
...
for (let i = 0; i < arraycards.lenght; i++)  {
    boxcards.innerHTML += arraycards[i];
}
